...
<Steps>
  ...
  <Step title="Read the Codebase">
    ...
    - [README.md](https://github.com/opencoredev/openchat) - Project overview
...
<CardGroup cols={2}>
  <Card title="GitHub Discussions" icon="comments" href="https://github.com/opencoredev/openchat/discussions">
    Ask questions and share ideas
  </Card>
  <Card title="GitHub Issues" icon="bug" href="https://github.com/opencoredev/openchat/issues">
