...
<img src="/images/openchat/features/chat-interface-hero-dark.png" alt="OpenChat dark-mode interface showing model and provider context" />

<img src="/images/openchat/features/model-selector-mobile-dark.png" alt="OpenChat dark-mode mobile layout for model and prompt controls" />
