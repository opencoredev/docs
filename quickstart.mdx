...
<img className="rounded-xl" src="/images/openchat/landing/osschat-signin-page-dark.png" alt="OpenChat sign-in screen in dark mode for OAuth setup" />
...
<Steps>
  ...
  <Step title="Start dev services">
    ...
    <img className="rounded-xl" src="/images/openchat/getting-started/quickstart-home-full-dark.png" alt="OpenChat app shell in dark mode after local services start" />
  </Step>
</Steps>
...
<img className="rounded-xl" src="/images/openchat/landing/osschat-signin-page-dark.png" alt="Expected dark-mode sign-in screen after opening the app" />

2. Sign in with GitHub; then the main app shell appears.

<img className="rounded-xl" src="/images/openchat/getting-started/quickstart-home-full-dark.png" alt="Main OpenChat dark-mode UI with chat sidebar and input" />
