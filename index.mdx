...
<img src="https://raw.githubusercontent.com/opencoredev/openchat/main/apps/web/public/og-image.png" alt="OpenChat interface overview" />
...
2. Read `/features/chat-experience` and `/features/model-selection`.
3. Use `/api-reference/introduction` for endpoint-level details.
